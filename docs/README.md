...
are derivative bounded-agent inputs and stop on contradiction. None of them authorizes a package,
provider, topology, runtime behavior, Product Pulse or optional-depth acceptance.
