...
fn cmd_index_directory(arguments: &[OsString]) -> Result<(), String> {
    with_store_mut(Path::new(&arguments[1]), |root, store| {
...
fn cmd_retire_source(arguments: &[OsString]) -> Result<(), String> {
...
fn cmd_read_revision(arguments: &[OsString]) -> Result<(), String> {
...
fn cmd_repair_root(arguments: &[OsString]) -> Result<(), String> {
...
fn cmd_gc_root(arguments: &[OsString]) -> Result<(), String> {
